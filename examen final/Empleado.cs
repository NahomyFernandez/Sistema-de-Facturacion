...
namespace examen_final
{
    internal class Empleado : Item
    {
        ...
        public Empleado(Consola _consola, BaseDatos _objBD, String _Codigo, String Nombres, String Cargo, String Area, Double Sueldo) : base(_consola, _objBD, _Codigo, "Empleado", "Cédula")
        {
