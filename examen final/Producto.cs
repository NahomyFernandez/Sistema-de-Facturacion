...
namespace examen_final
{
    internal class Producto : Item
    {
        ...
        public Producto(Consola _consola, BaseDatos _objBD, String _Codigo, String _DescripcionProducto, String _Marca, String _Tipo, Double _Precio, int IVA) : base(_consola, _objBD, _Codigo, "Producto", "Código")
        {
