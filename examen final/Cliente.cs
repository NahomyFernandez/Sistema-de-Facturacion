...
namespace examen_final
{
    internal class Cliente : Item
    {
        ...
        public Cliente(Consola _consola, BaseDatos _objBD, int IDCliente, String _Codigo, String Nombres, String Direccion, String Telefono) : base(_consola, _objBD, _Codigo, "Cliente", "Cédula")
        {
