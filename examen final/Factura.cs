...
namespace examen_final
{
    internal class Factura :Item
    {
        ...
        public Factura(Consola _consola, BaseDatos _objBD, String _Codigo, int IDCliente, String Cliente, DateTime Fecha, double SubTotal, double IVA, double TotalPagar) : base(_consola, _objBD, _Codigo, "Factura", "Número")
        {
